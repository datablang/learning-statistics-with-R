...
- les longueurs moyennes des odontoblastes diffèrent significativement entre les cobayes auxquels on a administré de la vitamine C pure à une dose de 0.5 mg/jour, et ceux qui ont reçu du jus d'orange avec la même dose (p-value p ≃ 0.002 << 0.05),  
- même conclusion entre les cobayes qui ont reçu du jus d'orange à une dose de 0.5 mg/jour et ceux qui ont reçu du jus d'orange à une autre dose (p-values p ≃ 3.18e-07 << 0.05 et p ≃ 1.43e-10 << 0.05),  
